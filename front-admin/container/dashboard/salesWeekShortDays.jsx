    ...
    <MainCard weight={'200'} title={`Últimos 7 Dias $ ${numberFormat(totalProductPrice || 0)}`}>
      ...
      <Container>
        <WrapperBox bgColor='transparent'>
          ...
          <Text size='2em' color='#3f3e3e' >{numberFormat(dataSales?.getAllSalesStore?.length || 0)}</Text>
          <Text size='1.1em' color='#3f3e3e' >${numberFormat(totalProductPrice || 0)}</Text>
        </WrapperBox>
        <WrapperBox bgColor='transparent'>
          <Text size='1.2em'>Clientes Nuevos</Text>
          <Text size='2em' color='#3f3e3e' >{DataClients?.getAllClients?.length}</Text>
          {/* <Text size='1.1em' color='#3f3e3e' >{1 || 0}</Text> */}
        </WrapperBox>
        <WrapperBox bgColor='transparent'>
          <Text size='1.2em'>Usuario Visitaron el restaurante</Text>
          <Text size='2em' color='#3f3e3e' >{!!VISITOR && VISITOR?.getAllVisitorStore?.length || 0}</Text>
          {/* <Text size='1.1em' color='#3f3e3e' >{1 || 0}</Text> */}
        </WrapperBox>
      </Container>
      <Container>
